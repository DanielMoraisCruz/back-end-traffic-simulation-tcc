...
@app.post('/update_simulation/', response_model=SimulationIteration)
async def update_simulation():
    log.log_info('Updating simulation')

    # Chama a função de GeneticAlgorithm
    # Se não existir, cria uma nova
    # Se existir, atualiza os valores
    # Retorna o objeto de SimulationIteration
